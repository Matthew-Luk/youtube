...
const Video8 = (props) => {
    ...
    useEffect(() => {
        axios.get("https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UCwiTOchWeKjrJZw7S1H__1g&maxResults=1&order=date&key=AIzaSyBV2wtszNohOliJ6YkupLzK5q6OBJos904")
        .then((result) => {
