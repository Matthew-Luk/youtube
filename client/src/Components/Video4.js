...
const Video4 = (props) => {
    ...
    useEffect(() => {
        axios.get(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UCWJ2lWNubArHWmf3FIHbfcQ&maxResults=1&order=date&key=${process.env.REACT_APP_API_KEY}`)
        .then((result) => {
