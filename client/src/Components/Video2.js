...
const Video2 = (props) => {
    ...
    useEffect(() => {
        axios.get(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UC1bwliGvJogr7cWK0nT2Eag&maxResults=1&order=date&key=${process.env.REACT_APP_API_KEY}`)
        .then((result) => {
