...
const Video6 = (props) => {
    ...
    useEffect(() => {
        axios.get(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UC68TLK0mAEzUyHx5x5k-S1Q&maxResults=1&order=date&key=${process.env.REACT_APP_API_KEY}`)
        .then((result) => {
