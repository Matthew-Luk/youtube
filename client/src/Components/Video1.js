...
const Video1 = (props) => {
    ...
    useEffect(() => {
        axios.get(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&channelId=UCzQUP1qoWDoEbmsQxvdjxgQ&maxResults=1&order=date&key=${process.env.REACT_APP_API_KEY}`)
        .then((result) => {
